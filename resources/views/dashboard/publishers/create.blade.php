        ...
        <div class="row">
            <div class="col-md-12 col-sm-12">
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        <form  action="/backboard/publishers" method="post" novalidate>
                            @csrf
                            <div class="field item form-group">
                                <label class="col-form-label col-md-3 col-sm-3  label-align">Name<span class="required">*</span></label>
                                <div class="col-md-6 col-sm-6">
                                    <input class="form-control @error('name') is-invalid @enderror" type="text" data-validate-length-range="6" data-validate-words="2" name="name" required="required" value="{{ old('name') }}" />
                                    @error('name')
                            ...
                            <div class="field item form-group">
                                ...
                                <div class="col-md-6 col-sm-6">
                                    <input class="form-control @error('alias') is-invalid @enderror" type="text" name="alias" data-validate-length-range="5,15"  value="{{ old('alias') }}"/>
                                    @error('alias')
                                    <div class="invalid-feedback">
                                      {{ $message }}
                                    </div>
                            ...
                            <div class="field item form-group">
                                ...
                                <div class="col-md-6 col-sm-6">
                                    <input class="form-control @error('website') is-invalid @enderror" name="website" required="required" type="text" value="{{ old('website') }}"/>
                                    @error('website')
                                    <div class="invalid-feedback">
                                      {{ $message }}
                                    </div>
                            ...
                            <div class="field item form-group">
                                ...
                                <div class="col-md-6 ">
                                    <textarea class="col-lg-12" required="required" rows="10"  name='abstract'></textarea></div>
                                    @error('abstract')
