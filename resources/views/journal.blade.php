...
<section class="section-hero overlay inner-page bg-image" style="background-image: url('../images/hero_1.jpg');" id="home-section">
  ...
  <section class="site-section">
    <div class="container">
      ...
      <section class="site-section">
        <div class="container">
          <form action="/journals/{{ $journal->id }}" method="get" class="search-jobs-form">
            <div class="row mb-5">
              <div class="col-12 col-sm-6 col-md-6 col-lg-9 mb-4 mb-lg-0">
                <input type="text" name="article" class="form-control form-control-lg" placeholder="Title article ... " value="{{ request('article') }}">
              </div>
          ...
          <div class="row pagination-wrap">
            <div class="col-md-6 text-center text-md-left mb-4 mb-md-0">
              ...
              @else
              <span>Showing {{ $articles->count() }} Articles</span>
              @endif
            </div>
